class Computer:
    ...
    def __init__(self, is_example: bool):
        ...
        self.register_A = 729 if is_example else 63281501
        self.register_B = 0
        self.register_C = 0
        self.program = [0,1,5,4,3,0] if is_example else [2,4,1,5,7,5,4,5,0,3,1,6,5,5,3,0]
    ...
    def run_program(self):
        ...
        print (",".join(str(x) for x in self.output_buffer))
